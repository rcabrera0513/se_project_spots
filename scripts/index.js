...
import { enableValidation, settings, hideInputError, toggleButtonState } from "./validation.js";
...
function getCardElement(data) {
  ...
  cardElement._id = data._id; // Store the card ID for deletion
...
const cardDeleteBtnEl = cardElement.querySelector(".card__delete-btn");
  cardDeleteBtnEl.addEventListener("click", () => {
    ...
    selectedCardId = cardElement._id;
    handleDeleteCard();
  });
